                      ...
                      <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full px-3">
                          ...
                          <input
                            ...
                            id="email"
                            name="email"
                            placeholder="welovecoley@example.com"
                            required
                          />
                        </div>
                      </div>
                      <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full px-3">
                          ...
                          <textarea
                            ...
                            id="message"
                            name="message"
                            placeholder="Your message here! (please include specific details of the shoot)"
                            required
                          ></textarea>
                        </div>
                      </div>
